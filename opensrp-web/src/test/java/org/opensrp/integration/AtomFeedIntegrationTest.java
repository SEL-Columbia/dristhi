...
public class AtomFeedIntegrationTest extends TestResourceLoader {
	...
	@Autowired
	private AllMarkersCouchImpl iamcd;
    ...
    public void shouldReadEventsCreatedEvents() throws URISyntaxException {
		...
		PatientAtomfeed paf = new PatientAtomfeed(iamcd, new AllFailedEventsInMemoryImpl(), openmrsOpenmrsUrl, patientService, clientService);

		paf.processEvents();
        
		EncounterAtomfeed eaf = new EncounterAtomfeed(new AllMarkersInMemoryImpl(), new AllFailedEventsInMemoryImpl(), openmrsOpenmrsUrl, encounterService, eventService);
		eaf.processEvents();
    }
}
