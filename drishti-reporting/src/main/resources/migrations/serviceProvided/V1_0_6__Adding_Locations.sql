...
INSERT INTO report.dim_location(state, district, taluka, phc, subCenter, village) VALUES ('Karnataka', 'Mysore', 'K.R. Nagar', (SELECT ID FROM report.dim_phc WHERE phcIdentifier='bherya'), 'hosa_agrahara', 'harambanahalli_koppalu');
INSERT INTO report.dim_location(state, district, taluka, phc, subCenter, village) VALUES ('Karnataka', 'Mysore', 'K.R. Nagar', (SELECT ID FROM report.dim_phc WHERE phcIdentifier='bherya'), 'hosa_agrahara', 'hosa_agrahara');
INSERT INTO report.dim_location(state, district, taluka, phc, subCenter, village) VALUES ('Karnataka', 'Mysore', 'K.R. Nagar', (SELECT ID FROM report.dim_phc WHERE phcIdentifier='bherya'), 'hosa_agrahara', 'mandiganahalli');

INSERT INTO report.dim_location(state, district, taluka, phc, subCenter, village) VALUES ('Karnataka', 'Mysore', 'K.R. Nagar', (SELECT ID FROM report.dim_phc WHERE phcIdentifier='bherya'), 'munjanahalli', 'chikkabherya');
...
INSERT INTO report.dim_location(state, district, taluka, phc, subCenter, village) VALUES ('Karnataka', 'Mysore', 'Mysore', (SELECT ID FROM report.dim_phc WHERE phcIdentifier='keelanapura'), 'puttegowdanahundi', 'duddagere');
INSERT INTO report.dim_location(state, district, taluka, phc, subCenter, village) VALUES ('Karnataka', 'Mysore', 'Mysore', (SELECT ID FROM report.dim_phc WHERE phcIdentifier='keelanapura'), 'puttegowdanahundi', 'lakshmipura');
INSERT INTO report.dim_location(state, district, taluka, phc, subCenter, village) VALUES ('Karnataka', 'Mysore', 'Mysore', (SELECT ID FROM report.dim_phc WHERE phcIdentifier='keelanapura'), 'puttegowdanahundi', 'mahadevi_colony');
INSERT INTO report.dim_location(state, district, taluka, phc, subCenter, village) VALUES ('Karnataka', 'Mysore', 'Mysore', (SELECT ID FROM report.dim_phc WHERE phcIdentifier='keelanapura'), 'puttegowdanahundi', 'puttegowdanahundi');

INSERT INTO report.dim_location(state, district, taluka, phc, subCenter, village) VALUES ('Karnataka', 'Mysore', 'Mysore', (SELECT ID FROM report.dim_phc WHERE phcIdentifier='keelanapura'), 'vajamangala', 'chikkahalli');
INSERT INTO report.dim_location(state, district, taluka, phc, subCenter, village) VALUES ('Karnataka', 'Mysore', 'Mysore', (SELECT ID FROM report.dim_phc WHERE phcIdentifier='keelanapura'), 'vajamangala', 'halagayanahundi');
INSERT INTO report.dim_location(state, district, taluka, phc, subCenter, village) VALUES ('Karnataka', 'Mysore', 'Mysore', (SELECT ID FROM report.dim_phc WHERE phcIdentifier='keelanapura'), 'vajamangala', 'vajamangala');
