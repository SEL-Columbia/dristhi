...
class MobileWorkers
  ...
  def initialize
    @mobileWorkers = {
        ...
        "bhe1" => MobileWorker.new("bhe1", "examples/Bherya A_EC data_Oct 2013.xlsx"),
        ...
        "bhe5" => MobileWorker.new("bhe5", "examples/Munjanahalli_For DRISTHI Training v1.xlsx"),
        "klp1" => MobileWorker.new("klp1", "examples/6 Dhakshakanya PGHundi.xlsx"),
        "klp2" => MobileWorker.new("klp2", "examples/7 N.R. Kamalakshi Keelanapura-B.xlsx"),
        "klp3" => MobileWorker.new("klp3", "examples/8 B.T.Indira Vajamangala.xlsx"),
        "klp4" => MobileWorker.new("klp4", "examples/9 Hemavathi Keelanapura-A.xlsx"),
