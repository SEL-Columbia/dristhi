  ...
  def self.code_to_village_hash
    {
        ...
        "29230030066a" => Village.new("bherya", "bherya-b", "half_bherya"),
        "29230030059" => Village.new("bherya", "g.a.guppe", "arakere"),
        "29230030056" => Village.new("bherya", "g.a.guppe", "g.a.guppe"),
        "29230030056a" => Village.new("bherya", "g.a.guppe", "udayagiri"),
        ...
        "29230040137a" => Village.new("keelanapura", "keelanapura-b", "gurukarapura"),
