  ...
  def read_from xlsx_filename
    ...
    begin
      ...
      CSV.foreach(filename, {:headers => true}) do |csv_row|
        ...
        anc_service.convert_value "Village Code", Village.code_to_village_hash

        anc_service.convert_value "e.Village Code", Village.code_to_village_hash


        anc_service.convert_value "eVillage Code", Village.code_to_village_hash
        ...
        tt_dose_given = "ttbooster" unless (anc_service['TT Booster'] rescue "").empty?
