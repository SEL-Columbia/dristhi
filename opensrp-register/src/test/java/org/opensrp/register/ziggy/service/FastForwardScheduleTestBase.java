...
public class FastForwardScheduleTestBase {
    ...
    public FastForwardScheduleTestBase forANCSchedule() {
        ...
        this.serviceCall = new Action() {
            ...
            public void make(String caseId, int visitNumber, LocalDate visitDate) {
                schedulesService.ancVisitHasHappened(caseId, "ANM 1", visitNumber, visitDate.toString(), "fs1");
            }
        };
        return this;
    }
    ...
    public FastForwardScheduleTestBase forTT1Schedule() {
        ...
        this.serviceCall = new Action() {
            @Override
            public void make(String caseId, int visitNumber, LocalDate visitDate) {
                schedulesService.ttVisitHasHappened(caseId, "ANM 1", "tt1", visitDate.toString(), "fs1");
            }
        };
        return this;
    }
    ...
    public FastForwardScheduleTestBase forTT2Schedule() {
        ...
        this.serviceCall = new Action() {
            @Override
            public void make(String caseId, int visitNumber, LocalDate visitDate) {
                schedulesService.ttVisitHasHappened(caseId, "ANM 1", "tt2", visitDate.toString(), "fs1");
            }
        };
        return this;
    }
    ...
    private FastForwardScheduleTestBase forIFASchedule(final String scheduleName) {
        ...
        this.serviceCall = new Action() {
            ...
            public void make(String caseId, int visitNumber, LocalDate visitDate) {
                ...
                schedulesService.ifaTabletsGiven(caseId, "ANM 1", numberOfIFATabletsGiven, visitDate.toString(), "fs1");
            }
        };
        return this;
    }
    ...
    public void willFulfillFor(String... expectedVisitCodes) {
        ...
        when(sf.getEnrollmentRecord("Case X", scheduleName)).thenReturn(recordForNextMilestone);
    ...
    private void verifyAllActionInteractions(List<String> expectedVisitCodes) {
        if (expectedVisitCodes.isEmpty()) {
        	...
        	verify(sf, atMost(1)).getEnrollmentRecord("Case X", scheduleName);
        ...
        for (String visitCode : expectedVisitCodes) {
            ...
            verify(sf).fullfillMilestoneAndCloseAlert("Case X", "ANM 1", scheduleName, visitCode, today(), "fs1");
        }
