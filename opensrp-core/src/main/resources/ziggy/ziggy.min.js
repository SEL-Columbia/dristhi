...
(function(global) {
    ...
    var o = function(e, t, n) {
        ...
        u = function(e, t, n, r) {
            ...
            s.createField(s.source + "." + i, s.source + "." + i, i, n)
        },
        a = function(e, t) {
    ...
    return {
        ...
        mapToEntityAndSave: function(e, t) {
            ...
            t.form.fields.forEach(function(t) {
                ...
                r.hasValue(o) || (o = e.findEntityDefinitionByType(s).createInstance(), o.source = t.source.substring(0, t.source.lastIndexOf(".")), n.add(o)), o.createField(t.name, t.source, i[i.length - 1], t.value)
            });
            var i = s.newInstance();
            r.hasValue(t.form.sub_forms) && t.form.sub_forms.forEach(function(t) {
                t.instances.forEach(function(n) {
                    ...
                    t.fields.forEach(function(e) {
                        ...
                        r.createField(e.name, e.source, t[t.length - 1], n[e.name])
    ...
    var e = function(e) {
        ...
        }, t.createField = function(e, n, r, i) {
