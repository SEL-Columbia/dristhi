    ...
    public static EnrollmentRequest enrollmentFor(final String entityId, final String scheduleName, final String name, final String referenceDate) {
        return argThat(new ArgumentMatcher<EnrollmentRequest>() {
            ...
            public boolean matches(Object o) {
                ...
                return entityId.equals(request.getExternalId())
                        && parse(referenceDate).equals(request.getReferenceDate())
                        && scheduleName.equals(request.getScheduleName())
                        && (name == null ? request.getStartingMilestoneName() == null : name.equals(request.getStartingMilestoneName()));
            }
        });
    }
