...
public enum Indicator {
    ...
    CHILD_MORTALITY("UFM"), INFANT_BALANCE_TOTAL("IBT"), INFANT_BALANCE_ON_HAND("IB_OH"), INFANT_LEFT("INFANT_LEFT"), CONDOM_QTY("CONDOM_QTY"),

    //NRHM Indicators
    NRHM_JSY_REG("NRHM_JSY_REG"), NRHM_ANC3("NRHM_ANC3"), NRHM_SBA("NRHM_SBA");
