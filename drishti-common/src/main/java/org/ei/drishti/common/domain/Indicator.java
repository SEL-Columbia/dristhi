...
public enum Indicator {
    ...
    ANC("ANC"), ANC_BEFORE_12_WEEKS("ANC<12"), MOTHER_MORTALITY("MORT_M"), MTP_LESS_THAN_12_WEEKS("MTP<12"), MTP_GREATER_THAN_12_WEEKS("MTP>12"), SPONTANEOUS_ABORTION("SPONTANEOUS_ABORTION"),
