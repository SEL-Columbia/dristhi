...
public enum Indicator {
    DPT("DPT"), PENTAVALENT3_OR_OPV3("PENTAVALENT3_OPV3"), DPT_BOOSTER_OR_OPV_BOOSTER("DPTB_OPVB"), DPT_BOOSTER2("DPT_BOOSTER_2"), HEP("HEP"), OPV("OPV"), MEASLES("MEASLES"),
    VIT_A_1("VIT_A_1"), VIT_A_1_FOR_FEMALE_CHILD("F_VIT_A_1"), VIT_A_1_FOR_MALE_CHILD("M_VIT_A_1"), VIT_A_2("VIT_A_2"), VIT_A_2_FOR_FEMALE_CHILD("F_VIT_A_2"), VIT_A_2_FOR_MALE_CHILD("M_VIT_A_2"),
    BCG("BCG"), PENT1("PENT1"), PENT2("PENT2"), PENT3("PENT3"), MMR("MMR"), JE("JE"),
    NM("NM"), LNM("LNM"), ENM("ENM"), INFANT_MORTALITY("IM"), CHILD_DIARRHEA("CHILD_DIARRHEA"), CHILD_MORTALITY_DUE_TO_DIARRHEA("CMD"), CHILD_MORTALITY("UFM"), LBW("LBW"), BF_POST_BIRTH("BF_POST_BIRTH"), WEIGHED_AT_BIRTH("WEIGHED_AT_BIRTH"),
