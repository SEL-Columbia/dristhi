...
public enum Indicator {
    DPT("DPT"), DPT1("DPT_1"), DPT2("DPT_2"), DPT3("DPT_3"), DPT3_OR_OPV3("DPT3_OPV3"), DPT_BOOSTER_OR_OPV_BOOSTER("DPTB_OPVB"), DPT_BOOSTER2("DPT_BOOSTER_2"), HEP("HEP"), OPV("OPV"), MEASLES("MEASLES"), VIT_A_1("VIT_A_1"), VIT_A_2("VIT_A_2"), BCG("BCG"),
