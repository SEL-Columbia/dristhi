...
public enum Indicator {
    DPT("DPT"), DPT1("DPT_1"), DPT2("DPT_2"), DPT3("DPT_3"), DPT_BOOSTER2("DPT_BOOSTER_2"), HEP("HEP"), OPV("OPV"), MEASLES("MEASLES"), BCG("BCG"), ENM("ENM"), CHILD_MORTALITY("MORT_C"), LBW("LBW"), BF_POST_BIRTH("BF_POST_BIRTH"), WEIGHED_AT_BIRTH("WEIGHED_AT_BIRTH"),
