...
public enum Indicator {
    ...
    NM("NM"), LNM("LNM"), ENM("ENM"), INFANT_MORTALITY("IM"), CHILD_DIARRHEA("CHILD_DIARRHEA"), CHILD_MORTALITY("UFM"), LBW("LBW"), BF_POST_BIRTH("BF_POST_BIRTH"), WEIGHED_AT_BIRTH("WEIGHED_AT_BIRTH"),
