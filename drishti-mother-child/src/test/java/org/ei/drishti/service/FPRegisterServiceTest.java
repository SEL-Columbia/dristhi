...
public class FPRegisterServiceTest {
    ...
    public void setUp() throws Exception {
        initMocks(this);
        registerService = new FPRegisterService(allEligibleCouples, reportMonth);
    }
    ...
    public void shouldGetFPRegisterForAGivenANM() throws Exception {
        ...
        EligibleCouple firstEligibleCouple = new EligibleCouple("ec id1", "90")
                ...
                .withDetails(details)
                .withIUDFPDetails(new IUDFPDetails(
                        "2014-02-23", "district hospital", "Follow up in 1 month"))
                .withOCPFPDetails(new OCPFPDetails("2014-02-23", asList(refill1, refill2, refill3, refill4)));
        EligibleCouple secondEligibleCouple = new EligibleCouple("ec id2", "91")
                .withCouple("Saranya", "Manjunatha")
                .withLocation("boregowdanakoppalu", "hosa_agrahara", "phc")
                .withDetails(details)
                .withCondomFPDetails(new CondomFPDetails("2014-02-23", asList(refill1, refill2)));
        ...
        EligibleCouple fourthEligibleCouple = new EligibleCouple("ec id4", "93")
                ...
                .withLocation("boregowdanakoppalu", "hosa_agrahara", "phc")
                .withDetails(details)
                .withMaleSterilizationFPDetails(new MaleSterilizationFPDetails("nsv", "2014-05-01", asList("2014-05-06",
                        "2014-05-10"), "Follow up in 1 month"));
        EligibleCouple fifthEligibleCouple = new EligibleCouple("ec id5", "94")
                .withCouple("Saranya", "Manjunatha")
                .withLocation("boregowdanakoppalu", "hosa_agrahara", "phc")
                .withDetails(details)
                .withFemaleSterilizationFPDetails(new FemaleSterilizationFPDetails("minilap", "2014-06-02", asList("2014-06-06",
                        "2014-06-10",
                        "2014-07-10"
        ...
        FPRegister expectedFPRegister = new FPRegister(asList(iudRegisterEntry), asList(condomRegisterEntry),
                asList(ocpRegisterEntry, anotherOCPRegisterEntry), asList(maleSterilizationRegisterEntry),
                asList(femaleSterilizationRegisterEntry), 2014);
        when(allEligibleCouples.allOpenECsForANM("anm1")).thenReturn(
                asList(firstEligibleCouple, secondEligibleCouple, thirdEligibleCouple, fourthEligibleCouple, fifthEligibleCouple));
