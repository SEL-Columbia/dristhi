...
public class DFLServiceTest {
    @Autowired
    private FormDataRepository formDataRepository;

    @Autowired
    @Value("#{drishti['form.files.path']}")
    ...
    public void setUp() throws Exception {
        jsonFileLoader = new JSONFileLoader(formFilePath);
    }
    ...
    public void test() throws Exception {
        ...
        DFLService service = new DFLService(jsonFileLoader, formDataRepository, "drishti-mother-child/js");
