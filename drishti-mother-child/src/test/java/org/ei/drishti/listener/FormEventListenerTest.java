...
public class FormEventListenerTest {
    ...
    public void shouldDelegateFormSubmissionToSubmissionService() throws Exception {
        List<FormSubmissionDTO> formSubmissions = asList(new FormSubmissionDTO("anm id 1", "instance id 1", "entity id 1", "form name", null, "0", "1","testvillage"),
                new FormSubmissionDTO("anm id 2", "instance id 2", "entity id 2", "form name", null, "0", "1","testvillage"));
    ...
    public void shouldFetchFormSubmissionsFromSubmissionService() throws Exception {
        List<FormSubmissionDTO> formSubmissions = asList(new FormSubmissionDTO("anm id 1", "instance id 1", "entity id 1", "form name", null, "0", "1","testvillage").withServerVersion("0"),
                new FormSubmissionDTO("anm id 2", "instance id 2", "entity id 2", "form name", null, "0", "1","testvillage").withServerVersion("0"));
        ...
        verify(formEntityService).process(asList(new FormSubmission("anm id 1", "instance id 1", "form name", "entity id 1", 0L, "1","testvillage", null, 0L),
                new FormSubmission("anm id 2", "instance id 2", "form name", "entity id 2", 0L, "1","village", null, 0L)));
    }
