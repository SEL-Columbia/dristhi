...
public class ANMReportScheduler {
    ...
    public static final long REPEAT_INTERVAL = 1L;
    ...
    public void startTimedScheduler() {
        ...
        RepeatingSchedulableJob job = new RepeatingSchedulableJob(event, startTime, null, REPEAT_INTERVAL * MILLIS_PER_HOUR);
